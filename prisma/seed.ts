...
async function main() {
    ...
    await prisma.user.upsert({
        where: { email: 'admin@fromcreate.jp' },
        update: {},
        create: {
            email: 'admin@fromcreate.jp',
    ...
    // Seed works data (from existing works-data.js)
    const worksData = [
        ...
        { id: 28, category: 'sns-domestic', title: 'Masa | 東京カフェ・グルメ（40.7万フォロワー）', thumbnail: '', videoUrl: 'https://www.instagram.com/ma_sa_cafe/' },
        { id: 32, category: 'sns-domestic', title: 'ajo.next0（TikTok）', thumbnail: '', videoUrl: 'https://www.tiktok.com/@ajo.next0' },
        { id: 33, category: 'sns-domestic', title: 'japan.sushi.school（TikTok）', thumbnail: '', videoUrl: 'https://www.tiktok.com/@japan.sushi.school' },
        { id: 29, category: 'sns-global', title: 'Harry Dhaliwal（41.3万フォロワー）', thumbnail: '', videoUrl: 'https://www.instagram.com/theharrydhaliwal/' },
        { id: 30, category: 'sns-global', title: 'H2H AUTO GROUP（1.2万フォロワー）', thumbnail: '', videoUrl: 'https://www.instagram.com/h2hautogroup/' },
        { id: 31, category: 'sns-global', title: 'パゥです🇵🇭（6.4万フォロワー）', thumbnail: '', videoUrl: 'https://www.instagram.com/pau_philippines' },
    ];
